...
<div align="center">
  ...
  <h3 align="center">NFT Minter</h3>

  <p align="center">
    A Nft minter made with node js.
    <br />
    <br />
...
1. Clone repo
   ```sh
   git clone https://github.com/Coding-Err0r/NFT-Minter.git
   ```
...
_For more examples, please refer to the [Documentation](https://docs.soliditylang.org/en/v0.8.16/)_
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/NFT-Minter.git)
